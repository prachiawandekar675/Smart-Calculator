...
response=['Welcome to smart calculator.','hello,My name is smart calculator .',
...
def sorry():
	print(response[3])
def help():
        print('\nHow it works on a calculator?\nIt needs to be given in input tax format only..\nAnd if you want to get out of this program.\nso You can type close,exit and end then end the program')
...
# commands
commands={'NAME':myname,'EXIT':end,'END':end,'CLOSE':end,'HELP':help}
		
print('-----',response[0],'-----')
print('-----',response[1],'-----')
print('\nIf you nedd any help ,type help...')
